...
// 2) Define required variables used to track the state of the game
	//	board, play, turn, winner

// 3) Store elements on the page that will be accessed in code more than once in variables to make code more concise, readable and performant.
	//So, what elements on the page needs to be access?
		// columns
		// rows
		// reset button
	//Then give them variables
...
// 5) Handle a player clicking a square
	// Add an eventListener? What type? ==> click event listener

// 6) Handle a player clicking the replay button
// Since most web apps are event-driven by nature. 
// Coding an event-driven program generally requires that we set up the application when it loads (steps 1 - 4) and wait for the user to interact with the app (steps 5 & 6).
